...
var initGl = function(){
	...
	if(!gl){
		console.log('webGL2.0 not supported, using webGL1.0');
		on_canvas.value = 'your browser seems not supporting webGL2.0';
	...
	switch(glVersion){
		case 2:compileVertextShader(null,vertexShaderSourceText2);
		case 1:compileVertextShader(null,vertexShaderSourceText);
		case 0:console.log("no supported GL Context");
	}
	start();
}
var loop = function(){
...
var start = function(){
	...
	var shaderText2 = "#version 300 es\nprecision mediump float;\nin vec2 position;\nuniform float time;\n ".concat(shaderSource.value);
	console.log(shaderText);
	if(vertexShader!=null){
		var fShader = gl.createShader(gl.FRAGMENT_SHADER);
		switch(glVersion){
			case 2:gl.shaderSource(fShader,shaderText);
			case 1:gl.shaderSource(fShader,shaderText);
			case 0:console.log("no supported GL Context");
		}
